...
People struggle to find the "magic" set of keywords to describe their information need. As we [first mentioned back in 2007](/rank-dynamics/hold-the-pickles-hold-the-lettuce "Hold the Pickles, Hold the Lettuce"):
...
As a result, people will often ultimately end up [fumbling and guessing](/rank-dynamics/maybe-if-i-just-add-some-quotes… "Maybe If I Just Add Some Quotes") with their search engine, which is humorously displayed in the video below.
