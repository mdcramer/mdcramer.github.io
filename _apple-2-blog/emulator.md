...
> Are you actually writing and running your code on the real physical <span class="no-break">Apple ]\[</span>, or are you using an emulator? If you're using a real one, how are you transferring the code back and forth from the <span class="no-break">Apple ]\[</span> to the blog? I'm guessing you're not using generative AI to write the code, since it sounds like writing it by hand is part of the fun. Is that right?
